...
CREDITS="Check out more comics by [turnoff.us](https://turnoff.us)"
FEED_URL="https://turnoff.us/feed.xml"
...
IMAGE_URL=$(echo "$RESPONSE" | grep -o '"content":"<img src=\\"[^"]*\\"' | head -1 | sed 's/.*src=\\"//' | sed 's/\\".*//')
